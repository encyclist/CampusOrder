...
public class PasswordView extends AppCompatEditText {
    ...
    private void setAttrs(AttributeSet attrs) {
        TypedArray t = mC.obtainStyledAttributes(attrs, R.styleable.PasswordView);
        if (t != null) {
            textLength = t.getInt(R.styleable.PasswordView_textLength,6);
            spzceX = t.getDimensionPixelSize(R.styleable.PasswordView_space, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,3,getResources().getDisplayMetrics()));
            spzceY = t.getDimensionPixelSize(R.styleable.PasswordView_space, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,3,getResources().getDisplayMetrics()));
            StrokeWidth = t.getDimensionPixelSize(R.styleable.PasswordView_strokeWidth, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,1,getResources().getDisplayMetrics()));
            Round = t.getDimensionPixelSize(R.styleable.PasswordView_round, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,3,getResources().getDisplayMetrics()));
            Circle = t.getDimensionPixelSize(R.styleable.PasswordView_circles, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,7,getResources().getDisplayMetrics()));
            textSize = t.getDimensionPixelSize(R.styleable.PasswordView_textSize, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,16,getResources().getDisplayMetrics()));
            checkedColor = t.getColor(R.styleable.PasswordView_checkedColor,0xff44ce61);
            defaultColor = t.getColor(R.styleable.PasswordView_defaultColor,0xffd0d0d0);
            backColor = t.getColor(R.styleable.PasswordView_backColor,0xfff1f1f1);
            textColor = t.getColor(R.styleable.PasswordView_textColor,0xFF444444);
            waitInputColor = t.getColor(R.styleable.PasswordView_waitInputColor,0xFF444444);
            isPwd = t.getBoolean(R.styleable.PasswordView_isPwd,true);
            isWaitInput = t.getBoolean(R.styleable.PasswordView_isWaitInput,false);
            t.recycle();
        }
    }
