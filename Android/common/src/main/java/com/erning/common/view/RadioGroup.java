...
/**
 * author:      lin
 * date:        2018/9/26 18:46
 * description: 支持多行多列的RadioGroup，子view不是radioButton的话radiogroup.getChildAt()方法不可用
 */
...
public class RadioGroup extends LinearLayout {
    ...
    public void check(int id,boolean listener) {
        // don't even bother
        if (id != -1 && (id == mCheckedId)) {
            return;
        }
    ...
    private void setCheckedId(int id,boolean listener) {
        mCheckedId = id;
        if (mOnCheckedChangeListener != null && listener) {
